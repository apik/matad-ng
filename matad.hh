...
#procedure pochtabl(NN)
*  #[ Declarations :  The tables and their variables. Commentary.
*
*   The variable ep should be declared in the rest of the program.
*   It has a power limitation of 6.
*   Note the funny convention:
*   When the argument of PO or POINV is 0 or less we have
*   taken out an overal factor of 1/x/ep, cq. x*ep. This is to
*   avoid a temporary anomalous number of powers of ep which could
...
*
                                                                        ...
                                                                        #if `NN' > 20 
                                                                                #if `NN' > 24
                                                                                        #message Value of parameter in pochtabl readjusted to 24
                                                                                #endif
                                                                                #define N "24"
                                                                                #else
                                                                                #define N "20"
        ...
        #endif
*
*   The parameter N indicates how many elements we need on the
*   positive side.
*
        S   x;
        Table,check,strict,PO({-`N'+1}:`N',x?);
        Table,check,strict,POINV({-`N'+1}:`N',x?);
*
*  #] Declarations :
*  #[ PO-neg :  PO negative values
*
*   Note that we should divide the zero and negative formulae
*   here by (x*ep). The actual value of PO(0) is 1/x/ep.
*
        fill PO(0) = 1;
        fill PO(-1) = - 1 - x*ep - x^2*ep^2 - x^3*ep^3
        - x^4*ep^4 - x^5*ep^5 - x^6*ep^6;
        fill PO(-2) =
        + 1/2 + 3/4*x*ep + 7/8*x^2*ep^2 + 15/16*x^3*ep^3
        + 31/32*x^4*ep^4 + 63/64*x^5*ep^5 + 127/128*x^6*ep^6;
        fill PO(-3) =
        - 1/6
        - 11/36*x*ep
        - 85/216*x^2*ep^2
        - 575/1296*x^3*ep^3
        - 3661/7776*x^4*ep^4
        - 22631/46656*x^5*ep^5
        - 137845/279936*x^6*ep^6;
        #if `N' > 4
                fill PO(-4) =
                + 1/24
                + 25/288*x*ep
                + 415/3456*x^2*ep^2
                + 5845/41472*x^3*ep^3
                + 76111/497664*x^4*ep^4
                + 952525/5971968*x^5*ep^5
                + 11679655/71663616*x^6*ep^6;
                fill PO(-5) =
                - 1/120
                - 137/7200*x*ep
                - 12019/432000*x^2*ep^2
                - 874853/25920000*x^3*ep^3
                - 58067611/1555200000*x^4*ep^4
                - 3673451957/93312000000*x^5*ep^5
                - 226576032859/5598720000000*x^6*ep^6;
                #if `N' > 6
                        fill PO(-6) =
                        + 1/720
                        + 49/14400*x*ep
                        + 13489/2592000*x^2*ep^2
                        + 336581/51840000*x^3*ep^3
                        + 68165041/9331200000*x^4*ep^4
                        + 483900263/62208000000*x^5*ep^5
                        + 270127056529/33592320000000*x^6*ep^6;
                        fill PO(-7) =
                        - 1/5040
                        - 121/235200*x*ep
                        - 726301/889056000*x^2*ep^2
                        - 129973303/124467840000*x^3*ep^3
                        - 187059457981/156829478400000*x^4*ep^4
                        - 28139924320343/21956126976000000*x^5*ep^5
                        - 36845364451242061/27664719989760000000*x^6*ep^6;
                        #if `N' > 8
                                fill PO(-8) =
                                + 1/40320
                                + 761/11289600*x*ep
                                + 3144919/28449792000*x^2*ep^2
                                + 1149858589/7965941760000*x^3*ep^3
                                + 3355156783231/20074173235200000*x^4*ep^4
                                + 339302688554687/1873589501952000000*x^5*ep^5
                                + 2678744365563671119/14164336634757120000000*x^6*ep^6;
                                fill PO(-9) =
                                - 1/362880
                                - 7129/914457600*x*ep
                                - 30300391/2304433152000*x^2*ep^2
                                - 101622655189/5807171543040000*x^3*ep^3
                                - 300222042894631/14634072288460800000*x^4*ep^4
                                - 826117151879597149/36877862166921216000000*x^5*ep^5
                                - 2184117445022203447471/92932212660641464320000000*x^6*ep^6;
                                #if `N' > 10
                                        fill PO(-10) =
                                        + 1/3628800
                                        + 7381/9144576000*x*ep
                                        + 32160403/23044331520000*x^2*ep^2
                                        + 21945415349/11614343086080000*x^3*ep^3
                                        + 327873266234371/146340722884608000000*x^4*ep^4
                                        + 908741214970658641/368778621669212160000000*x^5*ep^5
                                        + 2413120231194809425003/929322126606414643200000000*x^6*ep^6;
                                        fill PO(-11) =
                                        - 1/39916800
                                        - 83711/1106493696000*x*ep
                                        - 4102360483/30672005253120000*x^2*ep^2
                                        - 31276937512951/170045597123297280000*x^3*ep^3
                                        - 5194481903600608411/23568319761289003008000000*x^4*ep^4
                                        - 159443775809313077987411/653313823782931163381760000000*x^5*ep^5
                                        - 4676788004935176736296015403/18109859195262851848942387200000000*x^6*ep^6;
                                        #if `N' > 12
                                                fill PO(-12) =
                                                + 1/479001600
                                                + 86021/13277924352000*x*ep
                                                + 4301068993/368064063037440000*x^2*ep^2
                                                + 33264031387717/2040547165479567360000*x^3*ep^3
                                                + 5578681466128739761/282819837135468036096000000*x^4*ep^4
                                                + 172330529996070466835321/7839765885395173960581120000000*x^5*ep^5
                                                + 5074871529226099514685606913/217318310343154222187308646400000000*x^6*ep^6;
                                                fill PO(-13) =
                                                - 1/6227020800
                                                - 1145993/2243969215488000*x*ep
                                                - 758647585777/808636746493255680000*x^2*ep^2
                                                - 77287019174361937/58280067593261923368960000*x^3*ep^3
                                                - 170044702211669500782121/105009025789539333526192128000000*x^4*ep^4
                                                - 68698758619138470404367234173/
                                                37841052533518394229498595246080000000*x^5*ep^5
                                                - 26399765160034818571989179349406177/
                                                13636401690978688544542113782877388800000000*x^6*ep^6;
                                                #if `N' > 14
                                                        fill PO(-14) =
                                                        + 1/87178291200
                                                        + 1171733/31415569016832000*x*ep
                                                        + 112686856171/1617273492986511360000*x^2*ep^2
                                                        + 81347802723340093/815920946305666927165440000*x^3*ep^3
                                                        + 180514164422163370751221/1470126361053550669366689792000000*x^4*ep^4
                                                        + 10477884744480707938214808959/
                                                        75682105067036788458997190492160000000*x^5*ep^5
                                                        + 28287670433295352528296723627638797/
                                                        190909623673701639623589592960283443200000000*x^6*ep^6;
                                                        fill PO(-15) =
                                                        - 1/1307674368000
                                                        - 1195757/471233535252480000*x*ep
                                                        - 476696711/99016744468561920000*x^2*ep^2
                                                        - 17055178843123409/2447762838917000781496320000*x^3*ep^3
                                                        - 190757504835343290196621/22051895415803260040500346880000000*x^4*ep^4
                                                        - 11132564501075606110169612231/
                                                        1135231576005551826884957857382400000000*x^5*ep^5
                                                        - 6031962308062447011326345395460321/
                                                        572728871021104918870768778880850329600000000*x^6*ep^6;
                                                        #if `N' > 16
                                                                fill PO(-16) =
                                                                + 1/20922789888000
                                                                + 2436559/15079473128079360000*x*ep
                                                                + 96568406789/310516510653410181120000*x^2*ep^2
                                                                + 142531324182321979/313313643381376100031528960000*x^3*ep^3
                                                                + 3212628164810309981747311/5645285226445634570368088801280000000*x^4*ep^4
                                                                + 376915326274973740257971537677/
                                                                581238566914842535365098422979788800000000*x^5*ep^5
                                                                + 81962999787375055541354912877997039/
                                                                117294872785122287384733445914798147502080000000*x^6*ep^6;
                                                                fill PO(-17) =
                                                                - 1/355687428096000
                                                                - 42142223/4357967734014935040000*x*ep
                                                                - 28776062218037/1525567616840204219842560000*x^2*ep^2
                                                                - 729291672694244960123/26168268808855913250733330268160000*x^3*ep^3
                                                                - 281462294311726805677013376031/
                                                                8015497745765419364179123461119016960000000*x^4*ep^4
                                                                - 564145222241140781833967990767603949/
                                                                14029686014368128821510003376465837765427200000000*x^5*ep^5
                                                                - 10461164856476842638038161189836649078663547/
                                                                240653112241754467740880813276977714544308859699200000000*x^6*ep^6;
                                                                #if `N' > 18
                                                                        fill PO(-18) =
                                                                        + 1/6402373705728000
                                                                        + 14274301/26147806404089610240000*x*ep
                                                                        + 29608882035581/27460217103123675957166080000*x^2*ep^2
                                                                        + 50500501069854396349/31401922570627095900879996321792000*x^3*ep^3
                                                                        + 294352799712312489617077371031/
                                                                        144278959423777548555224222300142305280000000*x^4*ep^4
                                                                        + 65863120942796227591592510480739821/
                                                                        28059372028736257643020006752931675530854400000000*x^5*ep^5
                                                                        + 88208355135479668752967444674123414750223/
                                                                        34654048162812643354686837111884790894380475796684800000*x^6*ep^6;
                                                                        fill PO(-19) =
                                                                        - 1/121645100408832000
                                                                        - 275295799/9439358111876349296640000*x*ep
                                                                        - 1568274265798307/26907089872903613341457448960000*x^2*ep^2
                                                                        - 1794683268312579709384043/
                                                                        20461649756633468824492910003261276160000*x^3*ep^3
                                                                        - 40009517970859535080774906095604951/
                                                                        357248987150256164200042141613160061961502720000000*x^4*ep^4
                                                                        - 170864658958309558725823727346322640908759/
                                                                        1320077877398654557458859718317620008155187930726400000000*x^5*ep^5
                                                                        - 545107754958038941477256969841397265941063458146891/
                                                                        3872034286835386580830089611201274450551405153503756576358400000000*x^6*ep^6;
                                                                        #if `N' > 20
                                                                                fill PO(-20) =
                                                                                + 1/2432902008176640000
                                                                                + 11167027/7551486489501079437312000*x*ep
                                                                                + 11256448518043769/3766992582206505867804042854400000*x^2*ep^2
                                                                                + 9279131712715653650968723/
                                                                                2046164975663346882449291000326127616000000*x^3*ep^3
                                                                                + 41629602590344731254886672725930611/
                                                                                7144979743005123284000842832263201239230054400000000*x^4*ep^4
                                                                                + 7142239112579651595742062778098987074987/
                                                                                1056062301918923645967087774654096006524150344581120000000*x^5*ep^5
                                                                                + 571294651960644279934630828168658674310905345370231/
                                                                                77440685736707731616601792224025489011028103070075131527168000000000*x^6*ep^6;
                                                                                fill PO(-21) =
                                                                                - 1/51090942171709440000
                                                                                - 18858053/264302027132537780305920000*x*ep
                                                                                - 80676574383943103/553747909584356362567194299596800000*x^2*ep^2
                                                                                - 9577241336253249489726083/
                                                                                42969464488930284531435111006848679936000000*x^3*ep^3
                                                                                - 6174587158661922297334017385371973/
                                                                                21434939229015369852002528496789603717690163200000000*x^4*ep^4
                                                                                - 111696754789037742399995916535691943099157/
                                                                                332659625104460948479632649016040242055107358543052800000000*x^5*ep^5
                                                                                - 597296825451676635924546421568548733116332437242151/
                                                                                1626254400470862363948637636704535269231590164471577762070528000000000*x^6*ep^6;
                                                                                fill PO(-22) =
                                                                                + 1/1124000727777607680000
                                                                                + 6364399/1938214865638610388910080000*x*ep
                                                                                + 82494882923667143/12182454010855839976478274591129600000*x^2*ep^2
                                                                                + 9868213987506291289829963/
                                                                                945328218756466259691572442150670958592000000*x^3*ep^3
                                                                                + 6398344963543032449814395864411773/
                                                                                471568663038338136744055626929371281789183590400000000*x^4*ep^4
                                                                                + 116210352073359830867133385439115668950093/
                                                                                7318511752298140866551918278352885325212361887947161600000000*x^5*ep^5
                                                                                + 623120053293078163170149467651030900158655068872591/
                                                                                35777596810358972006870028007499775923094983618374710765551616000000000*x^6*ep^6;
                                                                                fill PO(-23) =
                                                                                - 1/25852016738884976640000
                                                                                - 444316699/3075946991768474687200296960000*x*ep
                                                                                - 44570695662918553607/148223917950083004993811166950273843200000*x^2*ep^2
                                                                                - 123525135034106281845251414461/
                                                                                264541594065028274578349323783885911723343872000000*x^3*ep^3
                                                                                - 264591239933345908907390540426325365899/
                                                                                433596809052309485437949317999638620563548468255129600000000*x^4*ep^4
                                                                                - 776713959740478684849561077289313689586845388571/
                                                                                1083402393408403076227243586991318834832866105871976452482662400000000*x^5*ep^5
                                                                                - 96041208895558385773482948005826382154738052851832630885359/
                                                                                121816472052416261093751730181537943909751715221890351995814993148772352000000000
                                                                                *x^6*ep^6;
                                                                        #endif
                                                                #endif
                                                        #endif
...
*
*  #] PO-neg : 
*  #[ PO-pos :  PO positive values
*
        fill PO(1) = 1;
        fill PO(2) = + 1 + x*ep;
        fill PO(3) = + 2 + 3*x*ep + x^2*ep^2;
        fill PO(4) = + 6 + 11*x*ep + 6*x^2*ep^2 + x^3*ep^3;
        #if `N' > 4
                fill PO(5) = + 24 + 50*x*ep + 35*x^2*ep^2 + 10*x^3*ep^3 + x^4*ep^4;
                fill PO(6) =
                + 120
                + 274*x*ep
                + 225*x^2*ep^2
                        ...
                        + 28*x^6*ep^6;
                                ...
                                + 9450*x^6*ep^6;
                                        ...
                                        + 2637558*x^6*ep^6;
                                                ...
                                                + 6227020800
                                                + 19802759040*x*ep
                                                + 26596717056*x^2*ep^2
                                                + 20313753096*x^3*ep^3
                                                + 9957703756*x^4*ep^4
                                                + 3336118786*x^5*ep^5
                                                + 790943153*x^6*ep^6;
                                                #if `N' > 14
                                                        ...
                                                        + 87178291200
                                                        + 283465647360*x*ep
                                                        + 392156797824*x^2*ep^2
                                                        + 310989260400*x^3*ep^3
                                                        + 159721605680*x^4*ep^4
                                                        + 56663366760*x^5*ep^5
                                                        + 14409322928*x^6*ep^6;
                                                        fill PO(16) =
                                                        + 1307674368000
                                                        + 4339163001600*x*ep
                                                        + 6165817614720*x^2*ep^2
                                                        + 5056995703824*x^3*ep^3
                                                        + 2706813345600*x^4*ep^4
                                                        + 1009672107080*x^5*ep^5
                                                        + 272803210680*x^6*ep^6;
                                                        #if `N' > 16
                                                                fill PO(17) =
                                                                + 20922789888000
                                                                + 70734282393600*x*ep
                                                                + 102992244837120*x^2*ep^2
                                                                + 87077748875904*x^3*ep^3
                                                                + 48366009233424*x^4*ep^4
                                                                + 18861567058880*x^5*ep^5
                                                                + 5374523477960*x^6*ep^6;
                                                                fill PO(18) =
                                                                + 355687428096000
                                                                + 1223405590579200*x*ep
                                                                + 1821602444624640*x^2*ep^2
                                                                + 1583313975727488*x^3*ep^3
                                                                + 909299905844112*x^4*ep^4
                                                                + 369012649234384*x^5*ep^5
                                                                + 110228466184200*x^6*ep^6;
                                                                #if `N' > 18
                                                                        fill PO(19) =
                                                                        + 6402373705728000
                                                                        + 22376988058521600*x*ep
                                                                        + 34012249593822720*x^2*ep^2
                                                                        + 30321254007719424*x^3*ep^3
                                                                        + 17950712280921504*x^4*ep^4
                                                                        + 7551527592063024*x^5*ep^5
                                                                        + 2353125040549984*x^6*ep^6;
                                                                        fill PO(20) =
                                                                        + 121645100408832000
                                                                        + 431565146817638400*x*ep
                                                                        + 668609730341153280*x^2*ep^2
                                                                        + 610116075740491776*x^3*ep^3
                                                                        + 371384787345228000*x^4*ep^4
                                                                        + 161429736530118960*x^5*ep^5
                                                                        + 52260903362512720*x^6*ep^6;
                                                                        #if `N' > 20
                                                                                fill PO(21) =
                                                                                + 2432902008176640000
                                                                                + 8752948036761600000*x*ep
                                                                                + 13803759753640704000*x^2*ep^2
                                                                                + 12870931245150988800*x^3*ep^3
                                                                                + 8037811822645051776*x^4*ep^4
                                                                                + 3599979517947607200*x^5*ep^5
                                                                                + 1206647803780373360*x^6*ep^6;
                                                                                fill PO(22) =
                                                                                + 51090942171709440000
                                                                                + 186244810780170240000*x*ep
                                                                                + 298631902863216384000*x^2*ep^2
                                                                                + 284093315901811468800*x^3*ep^3
                                                                                + 181664979520697076096*x^4*ep^4
                                                                                + 83637381699544802976*x^5*ep^5
                                                                                + 28939583397335447760*x^6*ep^6;
                                                                                fill PO(23) =
                                                                                + 1124000727777607680000
                                                                                + 4148476779335454720000*x*ep
                                                                                + 6756146673770930688000*x^2*ep^2
                                                                                + 6548684852703068697600*x^3*ep^3
                                                                                + 4280722865357147142912*x^4*ep^4
                                                                                + 2021687376910682741568*x^5*ep^5
                                                                                + 720308216440924653696*x^6*ep^6;
                                                                                fill PO(24) =
                                                                                + 25852016738884976640000
                                                                                + 96538966652493066240000*x*ep
                                                                                + 159539850276066860544000*x^2*ep^2
                                                                                + 157375898285941510732800*x^3*ep^3
                                                                                + 105005310755917452984576*x^4*ep^4
                                                                                + 50779532534302850198976*x^5*ep^5
                                                                                + 18588776355051949776576*x^6*ep^6;
                                                                        #endif
                                                                #endif
                                                        #endif
                                                #endif
...
*
*  #] PO-pos : 
*  #[ POINV-neg :  POINV negative values
*
*   Note that we should multiply the zero and negative formulae
*   here by (x*ep). The actual value of POINV(0) is x*ep.
*
        fill POINV(0) = 1;
        fill POINV(-1) = - 1 + x*ep;
        fill POINV(-2) = + 2 - 3*x*ep + x^2*ep^2;
        fill POINV(-3) = - 6 + 11*x*ep - 6*x^2*ep^2 + x^3*ep^3;
        #if `N' > 4
                fill POINV(-4) = + 24 - 50*x*ep + 35*x^2*ep^2 - 10*x^3*ep^3 + x^4*ep^4;
                fill POINV(-5) =
                - 120
                + 274*x*ep
                - 225*x^2*ep^2
...
*
*  #] POINV-neg : 
*  #[ POINV-pos :  POINV positive values
*
        fill POINV(1) = 1;
        fill POINV(2) = + 1 - x*ep + x^2*ep^2 - x^3*ep^3
        + x^4*ep^4 - x^5*ep^5 + x^6*ep^6;
        fill POINV(3) = + 1/2 - 3/4*x*ep + 7/8*x^2*ep^2 - 15/16*x^3*ep^3
        + 31/32*x^4*ep^4 - 63/64*x^5*ep^5 + 127/128*x^6*ep^6;
        fill POINV(4) =
        + 1/6
        - 11/36*x*ep
...
#procedure averts(P,in)
        ...
        if( count(int`in',1));        
        if ( count([x],1) != 0 );
        id [x]^s? =  acc(1-ep)*acc(POINV(s+2,-1))*`P'.`P'^(s)/2^s;
        endif;
        endif;        
        .sort
...
* #procedure one00(P,PQ,Q,EP,EPQ,EQ,INT)

*         id `PQ' = `Q' - `P';
*         id `P'.`Q' = `P'.`P'/2+`Q'.`Q'/2-`PQ'.`PQ'/2;
*         totensor,nosquare,`P',FQ;
*         id FQ(?a) = x^nargs_(?a)*FQ(?a);

* *
* *   Now relation (3.1) after which we don't need x anymore
* *
*         if ( count(x,1) == 0 );
*         id `INT'/`P'.`P'^x1?/`PQ'.`PQ'^x2?*`EP'^y1?*`EPQ'^y2? =
*         `Q'.`Q'^2/`Q'.`Q'^x1/`Q'.`Q'^x2*`EQ'^y1*`EQ'^y2*`EQ'*G(x1,y1,x2,y2,0,0);
*         elseif ( count(x,1) == 1 );
*         id `INT'/`P'.`P'^x1?/`PQ'.`PQ'^x2?*`EP'^y1?*`EPQ'^y2?*x*FQ(i1?) =
*         `Q'.`Q'^2/`Q'.`Q'^x1/`Q'.`Q'^x2*`EQ'^y1*`EQ'^y2*`EQ'
*         *G(x1,y1,x2,y2,1,0)*`Q'(i1);
*         elseif ( count(x,1) == 2 );
*         id `INT'/`P'.`P'^x1?/`PQ'.`PQ'^x2?*`EP'^y1?*`EPQ'^y2?*x^2*FQ(i1?,i2?) = 
*         `Q'.`Q'^2/`Q'.`Q'^x1/`Q'.`Q'^x2*`EQ'^y1*`EQ'^y2*`EQ'*(
*         G(x1,y1,x2,y2,2,0)*`Q'(i1)*`Q'(i2)
*         + G(x1,y1,x2,y2,2,1)*`Q'.`Q'*d_(i1,i2)/2 );
*         else;
*         id `INT'/`P'.`P'^x1?/`PQ'.`PQ'^x2?*`EP'^y1?*`EPQ'^y2?*x^s?*FQ(?a) =
*         `Q'.`Q'^2/`Q'.`Q'^x1/`Q'.`Q'^x2*`EQ'^y1*`EQ'^y2*`EQ'
*         *sum_(j,0,integer_(s/2),G(x1,y1,x2,y2,s,j)*`Q'.`Q'^j/2^j
*         *distrib_(1,2*j,del,dal,?a));
*         tovector,dal,`Q';
*         id del(?a) = dd_(?a);
*         endif;
...
*         id  G(x1?,y1?,0,0,?a) = 0;
*         id  G(0,0,?a) = 0;
*         id  G(2,0,1,0,0,0) = G(1,0,2,0,0,0);
...
#procedure averts2(P,in)
* version of 'averts' for 'tad2l'
        if( count(int`in',1));
        totensor,nosquare,`P',FQ;
...
* #include matad.info # time
        ...
        if ( (count(s1m,1)!=0) && (count(s2m,1)!=0) && (count(s3m,1)==0) ); 
        multiply replace_(test5,s1m,test6,s2m)*intMM0;

        elseif ( (count(s1m,1)!=0) && (count(s2m,1)==0) && (count(s3m,1)==0) );
*         multiply intd6;        
 
        multiply intM00;
*         #call one00{p2|p3|p1|e2|e3|e1|int1}
...
* identify simpler integrals
	...
	s1m,s3m,s3m,s5m,s4m,s1m,s5m,s4m,s6m,s2m);
        ...
        id s1m*s2m*s3m*s4m*s5m*s6m = 2*z3/ep + D6 + ep*D6ep;
        else;
        multiply 1/(1-1);
        endif;
        endif;
...
id s1m*s2m*s3m*s4m*s5m/p6.p6 = 2*z3/ep + D5 + ep*D5ep;
else;
multiply 1/(1-1);
endif;
endif;
...
id s1m*s2m/p3.p3*s4m/p5.p5*s6m = 2*z3/ep + D4 + ep*D4ep;
else;
multiply 1/(1-1);
endif;
endif;
...
elseif ( (count(s1m,1)==1)   && (count(s2m,1)==1)   && (count(p3.p3,1)==-1) && 
(count(p4.p4,1)==-1) && (count(p5.p5,1)==-1) && (count(p6.p6,1)==-1));
id s1m*s2m/p3.p3/p4.p4/p5.p5/p6.p6 = 2*z3/ep + DN + ep*DNep;
else;
multiply 1/(1-1);
endif;
endif;
...
* identify simple integrals
        ...
        id s1m*s2m*s3m/p4.p4/p5.p5 = 
        M^2 * (-2/3/ep^3-11/3/ep^2 + (-14 + (27*S2)/2 - 2*z2)/ep + E3 + ep*E3ep);
